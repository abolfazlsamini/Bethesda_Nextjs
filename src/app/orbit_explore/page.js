              ...
              <div className="carousel4_card_shadow relative mx-2 h-full cursor-pointer overflow-hidden rounded-xl bg-[#fcfcfc] p-1 px-4">
                ...
                <div className="text-black">
                  ...
                  <div className="netogame_H3 mt-3 pb-20 lg:my-5">
                    ...
                    According to our schedule, a demo version of the game will
                    be available on the store two months before the official
                    release
                  </div>
                </div>
            ...
            <div className="h-[55vh] rounded-xl sm:h-[70vh] lg:h-[50vh] xl:h-[66vh]">
              <div className="carousel4_card_shadow relative mx-2 h-full cursor-pointer overflow-hidden rounded-xl bg-[#fcfcfc] p-1 px-4">
                ...
                <div className="text-black">
                  ...
                  <div className="netogame_H3 mt-3 pb-20 lg:my-5">
                    Netoball will be available for Xbox Series X and PlayStation
                    5 in the second half of 2025. The PC version will also be
            ...
            <div className="h-[55vh] rounded-xl sm:h-[70vh] lg:h-[50vh] xl:h-[66vh]">
              <div className="carousel4_card_shadow relative mx-2 h-full cursor-pointer overflow-hidden rounded-xl bg-[#fcfcfc] p-1 px-4">
                ...
                <div className="text-black">
                  ...
                  <div className="netogame_H3 mt-3 pb-20 lg:my-5">
                    You'll have to wait until 2026 for Mythus Arena. The Neto
                    team is working tirelessly on this game, and we aim to
                    deliver the best strategy game experience for our users
                  </div>
                </div>
                <div className="absolute bottom-3 text-black">
                  <div className="flex">
              ...
              <div className="carousel4_card_shadow relative mx-2 h-full cursor-pointer overflow-hidden rounded-xl bg-[#fcfcfc] p-1 px-4">
                ...
                <div className="text-black">
                  ...
                  <div className="netogame_H3 mt-3 pb-20 lg:my-5">
                    ...
                    registration. If you're among the first 10,000 members,
                    you'll receive 1,000 Neto tokens as a gift for signing up,
                    which you can sell anytime you wish
                  </div>
                </div>
                <div className="absolute bottom-3 text-black">
                  <div className="flex">
            ...
            <div className="h-[55vh] rounded-xl sm:h-[70vh] lg:h-[50vh] xl:h-[66vh]">
              <div className="carousel4_card_shadow relative mx-2 h-full cursor-pointer overflow-hidden rounded-xl bg-[#fcfcfc] p-1 px-4">
                ...
                <div className="text-black">
                  ...
                  <div className="netogame_H3 mt-3 pb-20 lg:my-5">
                    Neto's first game to offer shares is NetoBall. The pre-sale
                    or initial offering of revenue and partnership shares for
              ...
              <div className="carousel4_card_shadow relative mx-2 h-full cursor-pointer overflow-hidden rounded-xl bg-[#fcfcfc] p-1 px-4">
                ...
                <div className="text-black">
                  ...
                  <div className="netogame_H3 mt-3 pb-20 lg:my-5">
                    ...
                    first-person shooter, thanks to the Unreal Engine, which
                    will provide realistic graphics and physics. A specific
                    release date for the game has not yet been determined
                  </div>
                </div>
                <div className="absolute bottom-3 text-black">
                  <div className="flex">
